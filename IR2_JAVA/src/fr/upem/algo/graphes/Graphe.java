...
public class Graphe {
	...
	/**
	 * Les méthodes statiques manipulent plusieurs sommets du graphe - le graphe
	 * est une collection de sommets - chaque sommet est vu comme le graphe égal
	 * à la composante connexe issue de ce sommet.
	 **/
	...
	/**
	 * S'il existe, affichage d'un chemin - Méthode basée sur le parcours en
	 * profondeur
	 **/
